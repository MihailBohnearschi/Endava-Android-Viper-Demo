package com.endava.viperdemo.utils;
...
public class UiUtils {
  ...
  public static void showSnackbar(View view, int resourceId, int length) {
    Snackbar.make(view, resourceId, length).setAction("Action", null).show();
  }
